...
- **RTC-64-u16-stream / RANKSTORE:** 64 `f32` locations and 64 prefix-rounded `u16` probability masses in a 400-byte target layout.
...
- This is an algorithmic Python/f64 prototype with persistent representatives rounded to `f32`; it does not predict Rust throughput.
